    ...
    <div className="min-h-screen bg-white text-slate-800 antialiased font-sans selection:bg-rose-900 selection:text-white overflow-x-hidden">
      ...
      <section className="relative bg-gradient-to-br from-rose-950 via-rose-900 to-red-950 text-white py-16 md:py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          {/* FLOATING MOCKUP SMARTPHONE (KANAN) */}
          <motion.div 
          ...
          >
            {/* Kartu Floating: Ucapan Doni */}
            <div className="absolute top-8 left-0 md:left-[-40px] z-20 bg-white text-stone-800 p-4 rounded-2xl shadow-2xl max-w-[210px] text-left border border-stone-100 animate-float">
            ...
            {/* Barcode Digital */}
            <div className="absolute bottom-16 left-6 md:left-2 z-20 bg-white p-3 rounded-xl shadow-2xl border border-stone-100 animate-float-delayed">
            ...
            {/* Statistik Kehadiran */}
            <div className="absolute top-24 right-0 md:right-[-20px] z-20 flex gap-2 animate-float">
            ...
            {/* Kartu Floating: Ucapan Evita */}
            <div className="absolute bottom-10 right-0 md:right-[-50px] z-20 bg-white text-stone-800 p-4 rounded-2xl shadow-2xl max-w-[190px] text-left border border-stone-100 animate-float-delayed">
      ...
      {/* 2.5 SECTION DETAIL EDUKASI (SCROLL ANIMATED ZIG-ZAG) */}
      <section className="bg-white py-20 px-6 border-b border-stone-100 overflow-hidden">
        <div className="max-w-6xl mx-auto space-y-28">
          ...
          >
            <motion.div variants={fadeInUp} className="lg:col-span-6 flex justify-center relative min-h-[300px] w-full group">
              <div className="w-[70%] h-[200px] bg-slate-50 border border-stone-200 rounded-xl p-3 shadow-md absolute left-4 top-4 transition-transform duration-500 group-hover:-translate-x-1 group-hover:-translate-y-1">
              ...
              <div className="w-[40%] h-[240px] bg-stone-900 border-4 border-stone-800 rounded-[24px] p-2 shadow-2xl absolute right-12 bottom-0 transition-transform duration-500 group-hover:scale-[1.03] overflow-hidden flex flex-col justify-between">
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-6 text-left space-y-4">
          ...
          >
            <motion.div variants={fadeInUp} className="lg:col-span-6 text-left space-y-4 order-2 lg:order-1">
              <h2 className="text-3xl md:text-4xl font-serif font-black text-rose-950 leading-tight">
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-6 flex justify-center relative min-h-[300px] w-full order-1 lg:order-2 group">
              <div className="absolute top-0 left-6 md:left-12 z-20 bg-white/95 border border-stone-100 p-3.5 rounded-2xl shadow-xl max-w-[210px] text-left backdrop-blur-sm transition-transform duration-500 group-hover:-translate-y-1">
              ...
              <div className="w-[45%] h-[240px] bg-stone-900 border-4 border-stone-800 rounded-[28px] p-2 shadow-2xl transition-transform duration-500 group-hover:rotate-1 overflow-hidden flex flex-col justify-between my-auto">
              ...
              <div className="absolute right-4 md:right-10 top-16 bg-white/90 border border-stone-200 px-5 py-2.5 rounded-xl shadow-xl font-bold text-xs text-emerald-600 tracking-wide backdrop-blur-sm transition-transform duration-500 group-hover:translate-x-1">
                WhatsApp
              </div>
            </motion.div>
          </motion.div>
      ...
      <section id="fitur" className="bg-white py-24 border-y border-stone-200/50 shadow-inner">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            {[
              { icon: '🎵', title: 'Cinematic Symphony', desc: 'Alunan simfoni melodi romantis mengalun secara anggun mengiringi langkah para tamu menelusuri lembar undangan.' },
              { icon: '📝', title: 'Real-Time RSVP', desc: 'Sistem pencatatan kehadiran otomatis serta doa restu terintegrasi, aman, dan dapat dipantau setiap detik.' },
              { icon: '📍', title: 'Live Navigation', desc: 'Peta digital presisi tinggi yang menuntun sanak saudara menuju lokasi pelaminan dengan akurat dan mudah.' }
            ].map((item, idx) => (
              <motion.div 
                key={idx}
                variants={fadeInUp}
              ...
              >
                <div className="w-14 h-14 bg-rose-50 text-rose-900 flex items-center justify-center rounded-2xl font-bold text-2xl mb-6 shadow-sm group-hover:bg-rose-900 group-hover:text-white transition-all duration-300 group-hover:rotate-6">
                  {item.icon}
                </div>
                <h3 className="font-serif font-bold text-xl text-stone-900">{item.title}</h3>
      ...
      <section id="harga" className="bg-stone-900 text-white py-24 border-t border-stone-800 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
          ...
          >
            {/* Paket Hemat */}
            <motion.div variants={fadeInUp} whileHover={{ y: -4 }} className="bg-stone-950/60 border border-stone-800 rounded-[32px] p-8 shadow-xl flex flex-col justify-between transition-all duration-300 hover:border-stone-700">
              <div>
              ...
              <a href="https://wa.me/6123456789" target="_blank" className="mt-8 w-full block bg-stone-800 hover:bg-rose-900 border border-stone-700 hover:border-rose-800 text-white font-bold py-3.5 px-4 rounded-xl text-center transition-colors text-xs tracking-wider uppercase">Pilih Paket Hemat</a>
            </motion.div>

            {/* Paket Standard */}
            <motion.div variants={fadeInUp} whileHover={{ y: -8 }} className="bg-white text-stone-900 border-2 border-rose-900 rounded-[32px] p-8 shadow-2xl flex flex-col justify-between relative transform md:-translate-y-4">
              ...
              <a href="https://wa.me/6123456789" target="_blank" className="mt-8 w-full block bg-rose-900 hover:bg-rose-950 text-white font-black py-4 px-4 rounded-xl text-center transition-colors text-xs tracking-wider uppercase shadow-lg shadow-rose-900/20">Ambil Paket Standard</a>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} whileHover={{ y: -4 }} className="bg-stone-950/60 border border-stone-800 rounded-[32px] p-8 shadow-xl flex flex-col justify-between transition-all duration-300 hover:border-stone-700">
              ...
              <a href="https://wa.me/6123456789" target="_blank" className="mt-8 w-full block bg-stone-800 hover:bg-rose-900 border border-stone-700 hover:border-rose-800 text-white font-bold py-3.5 px-4 rounded-xl text-center transition-colors text-xs tracking-wider uppercase">Pilih Paket Premium</a>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      {/* Keyframe disederhanakan dengan CSS Class Tailwind native */}
      <style jsx global>{`
        @keyframes float {
